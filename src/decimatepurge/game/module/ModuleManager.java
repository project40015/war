...
public class ModuleManager implements Manager {
	...
	private void fillModules() {
		...
		this.modules.add(new NoRegenerationModule(ModuleID.NO_REGENERATION_MODULE));
		this.modules.add(new RegularScoreboardInformationModule(ModuleID.REGULAR_SCOREBOARD_INFORMATION_MODULE));
		this.modules.add(new StartGameCommandModule(ModuleID.START_GAME_COMMAND_MODULE, "forcestart"));
		this.modules.add(new FactionCommandModule(ModuleID.FACTION_DEFAULT_COMMAND_MODULE, "factions"));
		this.modules.add(new ShoutCommandModule(ModuleID.SHOUT_COMMAND_MODULE, "shout"));
